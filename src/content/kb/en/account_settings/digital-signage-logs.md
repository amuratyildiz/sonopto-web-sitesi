...
-   Click on **Logs**
-   View the activity and type in a search text to filter the logs results
-   Click on the headers to sort the results(for example by date)
-   Click on **Export as CSV** to save the log report in a csv file
