---
title: 'Setup SAML 2.0 SSO for sonopto.signage and Azure Active Directory'
urlSlug: 'ad_sso'
...
-   SAML 2.0 SSO configuration works with the following Azure Plans:
    ...
    -   Pro Plus
    -   Enterprise plan
-   You have a sub domain of sonopto.signage and you require SAML 2.0 SSO to authenticate your users.
...
-   Enter _sonopto.signage_ as the name of the app.
...
-   Click Edit in Basic SAML Configuration, then in the dialog:
    ...
    -   Click on **Add Identifier** Identifier (Entity ID): this is your unique identifier provided by Sonopto support, paste it here
...
-   From Certificate (Base64), Click on Download. This file should be sent to Sonopto support.

<img src="/kb/integrations/5-ad-download-certificate.webp" alt="Certificate" loading="lazy" decoding="async">

#### Step 4

-   In Setup \[sonopto.signage\], copy the 2 below URLs, and send to Sonopto support.

<img src="/kb/integrations/6-ad-setup-urls.webp" alt="Setup URLs" loading="lazy" decoding="async">

## Map AD groups to sonopto.signage Accounts

-   We require to create groups and map them to sonopto.signage accounts, it is recommended to have seperate AD groups for your digital signage app.
-   Get the Group ID from Azure AD and provide it to Sonopto support and specify to which sonopto.signage user it should be mapped.
...
_To manage user roles in sonopto.signage, refer to [Teams](/en/support/user-management/teams/)._
