...
-   Check _Start slideshow as soon as the player loads_ to make the slideshow start automatically.
    
-   Check _Restart the slideshow after the last slide_ to make sure the slideshow loops when it ends.
