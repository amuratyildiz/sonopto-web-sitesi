...
-   To add content to your screen, click on Set Screen Content
-   Screens can be assigned to playlists, channels, groups, and schedules
...
_Note: If the screen is horizontal, only horizontal playlists will show, and if it’s vertical only vertical playlists will show._

-   To assign to a channel, click on **Channels**, then on the channel name
...
Check [Power Management](/en/support/screens/digital-signage-power-management/)

### Brightness Management

Check [Brightness Management](/en/support/screens/digital-signage-brightness-management/)
...
-   Type: All, Vertical, Horizontal
-   You can export players details as CSV file.
