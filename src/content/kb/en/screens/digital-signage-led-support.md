...
slug: 'digital-signage-led-support'
...
<img src="/destek/screens/led-layout.webp" alt="LED Layout" loading="lazy" decoding="async">

#### Step 2: Create a playlist

Create a playlist and choose a name that you can refer to it later.

<img src="/destek/screens/create_led_playlist.webp" alt="Create LED Playlist" loading="lazy" decoding="async">

Choose a layout with more than one layer, for example, layout 2

<img src="/destek/screens/led-playlist-choose-layout.webp" alt="Choose Layout" loading="lazy" decoding="async">

#### Step 3: Edit Layout

Click edit layout to optimise the layers to fit the LED resolution.

<img src="/destek/screens/led-playlist-edit-layout.webp" alt="Edit Layout" loading="lazy" decoding="async">
...
<img src="/destek/screens/led-playlist-set-layers.webp" alt="Set layers" loading="lazy" decoding="async">

The final layout should look like the one below.

<img src="/destek/screens/led-playlist-layer.webp" alt="LED layer" loading="lazy" decoding="async">

Click back, then click on the layer configured to upload your content.

<img src="/destek/screens/led-playlist-select-layer.webp" alt="Click on Layer" loading="lazy" decoding="async">
...
<img src="/destek/screens/led-playlist-upload-content.webp" alt="Upload Content" loading="lazy" decoding="async">

Once you upload your content, you should end up with something like the one below.

<img src="/destek/screens/led-playlist-content.webp" alt="Playlist content" loading="lazy" decoding="async">
...
<img src="/destek/screens/led-playlist-media-source.webp" alt="Select screen media source" loading="lazy" decoding="async">
...
<img src="/destek/screens/led-playlist-publish.webp" alt="Publish changes to the screen" loading="lazy" decoding="async">
...
<img src="/destek/screens/led-playlist-2-layers.webp" alt="LED with two layers" loading="lazy" decoding="async">
