...
export const en: Dictionary = {
  ...
  search: {
    pageTitle: 'Search',
    pageIntro: 'Services, solutions, sonopto.signage and the knowledge base — search every page on the site.',
    inputLabel: 'Search the site',
    placeholder: 'For example: samsung install, playlist, proof of play',
    submit: 'Search',
    resultCount: '%d results',
    empty: 'Nothing matched your search. Try a different word, or get in touch.',
    prompt: 'Type what you are looking for.',
    unavailable: 'The search index could not be loaded. Reload the page, and contact us if it keeps failing.',
    noScript:
      'Search needs JavaScript enabled in your browser. With it off, you can browse the knowledge base by category instead.',
    sections: {
      kb: 'Knowledge Base',
